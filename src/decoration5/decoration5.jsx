      ...
      <div key={props.key} id={props.id} className={"ams-decoration-5" + (props.className ? " " + props.className : "")} style={{ width: props.width ?? "100vw", height: props.height ?? "80px" }}>
        <svg width="100%" height="100%">
          <defs>
            ...
            <linearGradient id="ams-decoration5-gradient2">
              <stop offset="10%" stopColor={props.color ?? "rgb(1,255,255)"} stopOpacity="0.1" />
          ...
          <polyline fill="transparent" stroke="url(#ams-decoration5-gradient1)" strokeWidth="5"
            points={pointList[0]}
          >
          ...
          <polyline fill="transparent" stroke="url(#ams-decoration5-gradient2)" strokeWidth="5"
            points={pointList[2]}
          >
          ...
          <polyline fill="transparent" stroke={props.color ?? "rgb(1,255,255)"} strokeWidth="3" points={pointList[1]} >
